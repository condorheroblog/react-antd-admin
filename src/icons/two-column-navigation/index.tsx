...
export function TwoColumnNavigationSvg() {
	return (
		/**
		 * 更改了以下 svg 原属性
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="0.63em" viewBox="0 0 104 66" fill="none">
			<g>
				...
				<path fill="#1677ff" d="M-3.378 3.754A1.934 4.025 0 0 1-1.444-.27H9.904v66.405H-1.444a1.934 4.025 0 0 1-1.934-4.024V3.754z" />
				...
				<rect width="75.92" height="9.07" x="25.383" y="1.429" fill="currentColor" fillOpacity=".08" rx="2" />
				...
				<rect width="42.929" height="21.519" x="58.754" y="14.613" fill="currentColor" fillOpacity=".08" rx="2" />
				<rect width="28.369" height="20.978" x="26.143" y="14.613" fill="currentColor" fillOpacity=".08" rx="2" />
				<rect width="75.095" height="21.654" x="26.343" y="39.688" fill="currentColor" fillOpacity=".08" rx="2" />
...
export function TwoColumnNavigationIcon(props: Partial<CustomIconComponentProps>) {
	return <Icon component={TwoColumnNavigationSvg} {...props} />;
}
