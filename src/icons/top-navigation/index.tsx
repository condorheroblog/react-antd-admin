...
export function TopNavigationSvg() {
	return (
		/**
		 * 更改了以下 svg 原属性
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="0.63em" viewBox="0 0 104 66" fill="none">
			<g>
				...
				<path fill="#fff" d="M98.198 2.872c0-.543.457-1 1-1h1.925c.544 0 1 .457 1 1v2.4c0 .543-.456 1-1 1h-1.925c-.543 0-1-.457-1-1v-2.4z" />
				<rect width="53.604" height="21.519" x="43.484" y="13.667" fill="currentColor" fillOpacity=".08" rx="2" />
				<path fill="currentColor" fillOpacity=".08" d="M3.44 15.532c0-1.087 1.033-2 2.263-2h30.33c1.23 0 2.263.913 2.263 2V32.78c0 1.086-1.033 2-2.263 2H5.703c-1.23 0-2.264-.914-2.264-2V15.53z" />
				<rect width="95.025" height="21.654" x="3.304" y="39.347" fill="currentColor" fillOpacity=".08" rx="2" />
...
export function TopNavigationIcon(props: Partial<CustomIconComponentProps>) {
	return <Icon component={TopNavigationSvg} {...props} />;
}
