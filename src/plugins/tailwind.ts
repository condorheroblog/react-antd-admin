	...
	return {
		theme: {
			...
			colors: {
				 ...
				 * 说明：对于亮色和暗色模式，除基础色板外的颜色会自动适配主题，无需额外配置（例如：bg-color-border-secondary）
				 * 但基础色板（如 bg-cyan-100）仍需手动设置暗色模式样式
				 * @see https://ant.design/docs/spec/colors
				 *
				 * Tailwind CSS V4 有一个 bug，camelCase 风格的变量自动改为 kebab-case 风格
				 * @see https://github.com/tailwindlabs/tailwindcss/issues/18114
				 */
				...getColorPalettes,
			},
		},
